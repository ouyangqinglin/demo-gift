<template>
  <div class="cake-container" >
    ...
    <div class="button-style1" id="isLike" style="top:57%;width: 100%" align="center">
        <div class="lk1" style="margin: 0 20px; font-size: 22px; color: #fff">
        ...
        <table style="width: 100%;">
            <tr>
                <td style="display: flex; justify-content: center">
                    <a href="javascript:void(0)" class="lk1" style="float: right" @click="btnclick">
                        <div class="link1">
...
<script>
import $ from 'jquery'
import png from '../assets/img/HappyBirthday.png'
...
export default {
  ...
  methods: {
    btnclick () {
      $('#ILove').remove()
      $('#isLike').append(`<div class="lk1" id="ILove" style="opacity:1;font-size:10px;color: antiquewhite;" >我也喜欢你</div>`)
      $('#ILove').animate({
        opacity: '1',
        fontSize: '30px'
      }, 300)
    ...
    jump () {
      $('audio#cake-music')[0].pause()
      $('audio#img-music')[0].play()
      let url = '/img'
  ...
  mounted () {
    ...
    setTimeout(function () {
      $('.button-style1:not(#isLike)').animate({
        opacity: '1',
        top: '80%'
      }, 1500)
    }, 9000)
